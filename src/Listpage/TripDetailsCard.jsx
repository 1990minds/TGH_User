...
const TripDetailsCard = () => {
  ...
  return (
    ...
    <>
      ...
      <div className="max-w-lg rounded-3xl bg-white shadow-lg text-center hidden sm:block mx-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-1">
            ...
            <h3 className="text-2xl font-bold">{current_route?.to_location?.name}</h3>
            <p className="text-gray-600">{retrievedData?.dropStreet}</p>
          </div>
          <div className="space-y-4">
            <p className="text-gray-900 text-sm sm:text-base mt-1">{convertDateFormat(retrievedData?.date)}</p>
